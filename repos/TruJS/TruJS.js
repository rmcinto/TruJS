...
function resolvePath(name, scope) {
    //split the name
    var ns = name.split(SPLIT_PATH), parent, index;
    ...
    //return the scope
    return { "value": scope, "parent": parent, "index": index };
}
var SPLIT_PATH = /[.\[\]]/g;
...
*/
function isError(o) {
    return !!o && /^\[object\s[A-z]*Error\]$/g.test(Object.prototype.toString.call(o));
}
