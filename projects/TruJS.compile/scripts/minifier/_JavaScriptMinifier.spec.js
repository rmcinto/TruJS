/**[@test({ "title": "TruJS.compile.minifier._JavaScriptMinifier: options set with defaults, no error " })]*/
function testJavaScriptMinifier1(arrange, act, assert, callback, module) {
  ...
  arrange(function () {
    ...
    javaScriptMinifier = module(["TruJS.compile.minifier._JavaScriptMinifier", [, uglify, , defaults]]);
    fileObj = {
      "data": "data"
    };
    options = {
...
/**[@test({ "title": "TruJS.compile.minifier._JavaScriptMinifier: exception thrown" })]*/
function testJavaScriptMinifier2(arrange, act, assert, callback, module) {
  ...
  arrange(function () {
    ...
    javaScriptMinifier = module(["TruJS.compile.minifier._JavaScriptMinifier", [, uglify]]);
  });
...
/**[@test({ "title": "TruJS.compile.minifier._JavaScriptMinifier: minify error, allowErrors is false" })]*/
...
/**[@test({ "title": "TruJS.compile.minifier._JavaScriptMinifier: minify error, allowErrors is true" })]*/
