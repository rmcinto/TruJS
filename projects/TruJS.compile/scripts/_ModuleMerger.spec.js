/**[@test({ "title": "TruJS.compile._ModuleMerger: single module" })]*/
function testModuleMerger1(arrange, act, assert, module) {
  var moduleMerger, modules, resModule;

  arrange(function () {
    moduleMerger = module(["TruJS.compile._ModuleMerger", []]);
    modules = [{
...
/**[@test({ "title": "TruJS.compile._ModuleMerger: multiple complex modules" })]*/
function testModuleMerger1(arrange, act, assert, module) {
  var moduleMerger, modules, resModule;
...
/**[@test({ "title": "TruJS.compile._ModuleMerger: conflicting module entry types" })]*/
function testModuleMerger1(arrange, act, assert, module) {
  var moduleMerger, modules, resModule;
