/**[@test( { "title": "TruJS.compile._PathResolver: send undefined as the paths array" } )]*/
function testPathResolver1(arrange, act, assert, module) {
  var pathResolver, base, paths, res;

  arrange(function() {
    pathResolver = module(["TruJS.compile._PathResolver", []]);
    base = "/";
    paths = undefined;
  });
...
/**[@test( { "title": "TruJS.compile._PathResolver: send paths for each type" } )]*/
function testPathResolver1(arrange, act, assert, callback, mock, module) {
  ...
  arrange(function () {
    pathProcessor = callback(module(["TruJS.compile._PathProcessor", []]));
    ...
    pathResultProcessor = callback(module(["TruJS.compile._PathResultProcessor", []]));
    pathResolver = module(["TruJS.compile._PathResolver", [pathProcessor, pathResultProcessor, dirProcessor]]);
    base = "/base";
    paths = [
      "./path/file.js",
      "./path/*",
